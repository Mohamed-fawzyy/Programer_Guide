...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	if (empty($_POST['q1']) || empty($_POST['q2']) || empty($_POST['q3']) || empty($_POST['q4']) || empty($_POST['q5'])) {
		...
		if (mysqli_query($con,"UPDATE users SET user_ans_beg='q1)".$_POST['q1']."
    ...
    $sql = mysqli_query($con,"SELECT questions FROM htmlexam WHERE e_level = 'htmlbeg' ORDER BY tt;");
